...
# NOTE: this relies on alias lf=lfcd in your aliases file

function lfcd
    # populate the variable $lfb with the location of the lf binary on the current system
    set --export lfb (fish -c 'which lf')
    set tmp (mktemp)
